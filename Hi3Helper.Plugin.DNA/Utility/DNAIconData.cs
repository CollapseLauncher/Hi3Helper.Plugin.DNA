...
internal partial class DNAIconDataMap : JsonSerializerContext;
#endif

public static partial class DNAIconData
{
...
#else
                    await JsonSerializer.DeserializeAsync(copyToStream, DNAIconDataMap.Default.DictionaryStringString, token);
#endif
