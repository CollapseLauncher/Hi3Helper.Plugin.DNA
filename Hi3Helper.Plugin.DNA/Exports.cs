...
{
    static DNAbyss() => Load<DNAPlugin>(!RuntimeFeature.IsDynamicCodeCompiled ? new Core.Management.GameVersion(0, 4, 0, 0) : default); // Loads the IPlugin instance as DNAPlugin.
