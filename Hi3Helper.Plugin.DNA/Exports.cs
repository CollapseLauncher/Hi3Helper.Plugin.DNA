...
{
    static DNAbyss() => Load<DNAPlugin>(!RuntimeFeature.IsDynamicCodeCompiled ? new Core.Management.GameVersion(0, 3, 1, 0) : default); // Loads the IPlugin instance as DNAPlugin.
