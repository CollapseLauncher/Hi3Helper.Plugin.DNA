@echo off
set _pluginName=Hi3Helper.Plugin.DNA
...
mkdir "%outputDirPath%"
cd "%projectPath%"
dotnet restore --runtime win-x64 ..\Hi3Helper.Plugin.DNA.sln || goto :Error
dotnet clean --configuration %configuration% --runtime win-x64 ..\Hi3Helper.Plugin.DNA.sln || goto :Error
